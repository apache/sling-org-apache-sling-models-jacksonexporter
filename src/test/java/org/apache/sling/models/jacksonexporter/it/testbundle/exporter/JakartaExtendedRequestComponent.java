...
public class JakartaExtendedRequestComponent extends JakartaBaseRequestComponent {

    @Inject
    @Via("resource")
    private Date date;

    public JakartaExtendedRequestComponent(SlingJakartaHttpServletRequest request) {
        super(request);
    }
